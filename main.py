...
class TrainDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        target = {
            ...
            "masks": torch.as_tensor(np.stack(binary_masks, axis=0), dtype=torch.uint8),
...
def main():
    ...
    trainloader = DataLoader(trainset, batch_size=1, shuffle=False, collate_fn=lambda x: tuple(zip(*x)))
    ...
    scheduler = optim.lr_scheduler.ReduceLROnPlateau(optimizer, factor=0.5, patience=2, min_lr=1e-8, mode='min')
