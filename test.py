...
def main(i: int):
    ...
    file_to_id_map = {item['file_name']: item['id']
                      for item in test_image_info}
    file_to_height_map = {item['file_name']: item['height']
                          for item in test_image_info}
    file_to_width_map = {item['file_name']: item['width']
                         for item in test_image_info}
    ...
    for image, img_name in testloader:
        ...
        coco_outputs = convert_to_coco_format(
            outputs,
            image_id=image_id,
            height=height,
            width=width,
